...
if not Global.game_settings or not Global.game_settings.level_id or not Global.game_settings.level_id == "red2" or not Global.game_settings.single_player then
	return
end
